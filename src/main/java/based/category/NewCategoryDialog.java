...
public class NewCategoryDialog extends JDialog {
	...
	public NewCategoryDialog(Frame owner) {
		...
		{
			JLabel newCategoryLabel = DefaultComponentFactory.getInstance()
					...
					public void actionPerformed(ActionEvent e) {
						if (!Base.hasConnection()) {
							Base.open("com.mysql.jdbc.Driver",
									"jdbc:mysql://localhost/gradecalculator",
									"root", "mysql");
						}
						try {
							...
							if (totalWeight
									+ Double.parseDouble(newCategoryWeightTextField
											.getText()) / 100 <= 1.0) {
								category = Category.createIt(
										"name",
										newCategoryNameTextField.getText(),
										"weight",
										Double.parseDouble(newCategoryWeightTextField
												.getText()) / 100);
								GradeCalculator owner = (GradeCalculator) NewCategoryDialog.this
										.getOwner();
							...
							JOptionPane.showMessageDialog(
									NewCategoryDialog.this,
									"Please input a correct percent value",
